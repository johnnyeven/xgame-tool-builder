package com.xgame.tools.builder.common
{
	...
	public class EditorImpl implements IEditorManager
	{
		...
		private var _main: IEditorMXML;
		
		public function EditorImpl(main: IEditorMXML)
		{
			if(!_allowInstance)
			{
		...
		public static function init(main: IEditorMXML): EditorImpl
		{
			if(_instance == null)
			{
				_allowInstance = true;
		...
		public function get main(): IEditorMXML
		{
			return _main;
		}
